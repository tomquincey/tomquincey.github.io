...
$(document).ready(function () {
  ...
  $('.slide-menu-trigger-0').click(function(){
      $('.bodyclass').addClass('slide-menu-0-active').removeClass('slide-menu-0-f-active');
  });
  ...
  $('.slide-menu-trigger').click(function(){
      $('.bodyclass').addClass('slide-menu-active');
  });
  ...
  $('.slide-menu-trigger-4badges').click(function(){
      $('.bodyclass').removeClass('slide-menu-active').addClass('slide-menu-4-active');
  });
  
  
  $('#slide-content-darken').click(function(){
      $('.bodyclass').removeClass('slide-menu-0-active slide-menu-0-f-active slide-menu-active slide-menu-2-active slide-menu-3-active slide-menu-4-active');
  });
